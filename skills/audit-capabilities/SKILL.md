...
If the user authorizes implementation, invoke a skill-creation skill if one is installed — otherwise draft the SKILL.md directly — and add behavior-specific validation rather than continuing the audit.
