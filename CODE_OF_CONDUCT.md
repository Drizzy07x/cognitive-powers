...
All interaction with this project happens on GitHub: issues, pull requests, and
discussions. Report unacceptable behavior by using GitHub's own reporting tools
on the comment, issue, or account in question, which reaches both the platform
and the maintainer. The maintainer enforces this document using GitHub's
moderation controls, including hiding comments, locking threads, and blocking
accounts.
