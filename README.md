...
```powershell
git clone --branch v1.9.0 --depth 1 https://github.com/Drizzy07x/cognitive-powers
./cognitive-powers/install.ps1
```

```bash
git clone --branch v1.9.0 --depth 1 https://github.com/Drizzy07x/cognitive-powers && ./cognitive-powers/install.sh
```
...
restore the prior state if a step fails. Pass `-ReleaseRef v1.8.1` (or
