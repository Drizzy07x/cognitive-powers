...
```powershell
git clone --branch v1.10.0-rc.5 --depth 1 https://github.com/Drizzy07x/cognitive-powers
./cognitive-powers/install.ps1
```

```bash
git clone --branch v1.10.0-rc.5 --depth 1 https://github.com/Drizzy07x/cognitive-powers && ./cognitive-powers/install.sh
```
